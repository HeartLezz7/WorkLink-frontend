      ...
      <div className="relative w-screen h-[4000px] bg-primary overflow-hidden">
        <div className="bg-primary w-full h-[1100px] relative  max-w-[1440px] mx-auto">
          <div className="w-[1000px] h-[1000px] rounded-full overflow-hidden z-20 absolute left-[-300px] top-[100px]">
            <img
              src="/public/HomepagePhoto/team2.jpeg"
              alt=""
          ...
          <div>
            <div className="w-[500px] h-[500px] bg-secondaryLight/80 rounded-full overflow-hidden z-20 absolute left-[-500px] top-[-150px] shadow-md shadow-black/40"></div>
          </div>
        ...
        <div className="bg-primary w-full h-[1500px]  relative  max-w-[1440px] mx-auto">
          <div className="w-[1000px] h-[1000px] rounded-full overflow-hidden z-10 absolute left-[700px] top-[100px]">
            <img
              src="/public/HomepagePhoto/tutor.jpeg"
              alt=""
              className="h-full w-full object-cover"
            />
          </div>
          <div>
            <div className="w-[400px] h-[400px] bg-secondaryLight/80 rounded-full overflow-hidden z-20 absolute left-[-400px] top-[0px] shadow-md shadow-black/40"></div>
          </div>
          ...
          <div className="absolute left-[100px] top-[200px]">
            <div className="text-textWhite flex flex-col items-center">
              ...
              <h6>
                <br />
                When life gets busy, you don’t <br />
          ...
          <div className="absolute left-[350px] top-[1150px]">
            <div className="text-textWhite flex flex-col items-center">
              <h6 className="flex">
                Choose your
                <span className="text-secondaryDark  hover:text-secondaryLight text-3xl">
                  &nbsp;WorkLink&nbsp;{" "}
                </span>
        ...
        <div className="bg-primary w-full h-[1300px] relative  max-w-[1440px] mx-auto">
          <div className="w-[1000px] h-[1000px] rounded-full overflow-hidden z-10 absolute left-[-150px] top-[50px]">
            <img
              src="/public/HomepagePhoto/maid.jpeg"
              alt=""
              className="h-full w-full object-cover"
            />
          </div>
          ...
          <div>
            <div className="w-[800px] h-[800px] bg-secondaryLight rounded-full overflow-hidden z-20 absolute left-[1200px] top-[600px] shadow-md shadow-black/40"></div>
          </div>
          ...
          <div className="absolute left-[880px] top-[300px]">
            <div className="text-textWhite flex flex-col items-center">
              ...
              <h6>
                <br />
                Build your team of local, background-checked
                <span className="text-secondaryDark hover:text-secondaryLight text-[30px]">
                  &nbsp;WorkLink&nbsp;
                </span>
                <br />
                to help with — and for — life. Whatever you need, they’ve got it
                covered.
              </h6>
            </div>
          </div>
